...
resource "google_project_iam_member" "gha_www_kaito_tokyo_service_account_user" {
  project = var.project_id
...
resource "google_project_iam_member" "infra_manager_service_account_user" {
  project = var.project_id
  role    = "roles/iam.serviceAccountUser"
  member  = "serviceAccount:${google_service_account.infra_manager.email}"
}

resource "google_project_iam_member" "infra_manager_storage_admin" {
  project = var.project_id
